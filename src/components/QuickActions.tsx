    ...
    return (
        <View className='my-4 mx-4 flex flex-col gap-3 items-stretch select-none'>
            <View className='flex flex-row h-7 items-center justify-between'>
                <Text className='text-primary-text text-lg font-lexend-7'>Quick Actions</Text>
            </View>
            <ScrollView horizontal={true} contentContainerClassName='min-w-full flex flex-row justify-around gap-2'>
