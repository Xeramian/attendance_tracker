    ...
    return (
        <View className="flex flex-col items-center gap-4">
            ...
            <View className="flex-col gap-1 items-center">
                <AppText className='text-primary-text text-2xl text-fix font-lexend-7'>Xeramian</AppText>
                <View className="px-3 py-1 bg-page-offset h-6 flex-row items-center rounded-full">
                    <AppText className="text-quaternary-text leading-[14px] text-xs text-fix font-lexend-5">Roll No. 240102244</AppText>
                </View>
            </View>
        </View>
    );
