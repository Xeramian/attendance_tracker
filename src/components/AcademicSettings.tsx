    ...
    return (
        <View className="mx-4 flex-col items-start gap-2">
            ...
            <View className="self-stretch flex-col rounded-xl border-light-border border-2 bg-interactive">
                ...
                <Pressable onPress={() => { router.push('/manage-holidays') }}>
                    <SettingsTile icon="holiday-village"  primaryColor={colors.pink} secondaryColor={colors.pink_background} value="Manage Holidays" />
                </Pressable>
