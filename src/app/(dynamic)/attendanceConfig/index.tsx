...
export default function AttendanceDetailsScreen() {
    ...
    return (
        <PageLayout>
            <Header heading={"Set Target"} centerHeading={true} leftActions={[actions.back]} />
            <View className='flex flex-col py-4 gap-4 px-12'>
                ...
                <View className='flex flex-row gap-1 justify-center p-4'>
                    <View className='flex-row'>
                        <AppText className='opacity-0 self-center text-3xl text-fix font-lexend-7'>%</AppText>
                        <AppText className='text-primary-text text-7xl text-fix font-lexend-7'>{targetValue}</AppText>
                        <AppText className='text-secondary-text self-center text-3xl text-fix font-lexend-7'>%</AppText>
                    </View>
                </View>
